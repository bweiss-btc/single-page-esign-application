          ...
          {step === 0 && (
            <div style={slideStyle}>
              ...
              <div className="form-pad" style={{ padding: "20px 24px 24px", display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <Row><Textarea label="Description of Business" value={biz.description} onChange={v => upBiz("description", v)} placeholder="Briefly describe your business operations..." required error={E} id="biz-desc" maxLength={250} /></Row>
